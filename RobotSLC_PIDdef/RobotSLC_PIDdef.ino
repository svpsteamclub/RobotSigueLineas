...
float Kp = 80.0f;  //Controla que tanto corrige el robot, alto si tiene muchas curvas cerradas (80), bajarlo si el circuito es menos cerrado (40)
float Ki = 0.75f;  // Suavizado fino, dejar de ultimo.
float Kd = 12.0f;  //Controla las osilaciones, hay que subirlo si se sube Kp, bajarlo si se baja Kp.

//Valor maximo para la parte integral, no modificarlo.
float integralMax = 200.0f;

// === Constante para los motores ===
int baseSpeed = 250; // Velocidad base, 200 es un valor seguro (0-255)
